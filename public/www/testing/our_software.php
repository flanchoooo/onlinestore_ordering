         ...
         <div class="tab-pane active" id="a">
                <div class="row">
                  <div class="col-xs-9">
                      ...
                      <div class="row">
	                      <div class="col-xs-6"><br/><img class="img-responsive" src="images/software/propharm1.png"/></div>
	                      <div class="col-xs-6"><br/><img class="img-responsive" src="images/software/propharm2.png"/></div>
	                      <div class="col-xs-6"><br/></div>
	                      <div class="col-xs-6"><br/><img class="img-responsive" src="images/software/propharm3.png"/></div>
         ...
         <div class="tab-pane" id="b">
              <div class="row">
         	        <div class="col-xs-9">
         	           <div class="row">
		                   <div class="col-xs-6">
		                       <h3 class="hs">Elixir for Doctors </h3>
		                   </div>
		                   <div class="col-xs-6">
		                       <img src="images/software_icons/elixir.jpg" />
		                   </div>
	                   </div>
                       <div class="row">
                       <div class="col-xs-12">
	                   <p style="margin-top:10px">PRACTICE MANAGEMENT SOFTWARE FLEXIBLE ENOUGH TO BE
CUSTOMISED ACROSS A WIDE SPECTRUM OF USER SCENARIOS. Elixir allows you to :</p>
