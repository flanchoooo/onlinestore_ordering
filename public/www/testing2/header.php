	  ...
	  <!--header-->
		<div class="header">
			<div class="container">			
				...
				<div class="top-nav">
					<span class="menu"> <a class="toggleMenu" href="#"><img src="images/nav-ic.png" alt="" /> </a></span>
					<ul>
						...
						<li <?php if($page =='hardware'){ echo'class="active"';} else echo'';?>><a href="hardware" class="scroll">HARDWARE</a></li>
						<li <?php if($page =='support'){ echo'class="active"';} else echo'';?>><a href="support" class="scroll">SUPPORT</a></li>
	    ...
	    <div class="callbacks_container">
	      <ul class="rslides" id="slider">
	        <li>
	          <img src="images/headers/banner1.jpg" alt="">
		          <div class="div_btn">
		              <div class="col-md-12">
				              <div class="col-md-4">
				                   <button  class="flat-butt mobile1" onclick="window.location.href = 'our_software';">Pharmacy Management Systems</button>
				                   <button  class="flat-butt mobile1a" onclick="window.location.href = 'our_software';">PHM Systems</button>
				              </div>
				              <div class="col-md-4">
				                   <button class="flat-butt mobile1" onclick="window.location.href = 'our_software';">Practice Management Systems</button>
				                    <button class="flat-butt mobile1a" onclick="window.location.href = 'our_software';">PRM Systems</button>
				              </div>
				              <div class="col-md-4">
				                  <button class="flat-butt mobile1" onclick="window.location.href = 'hardware';">Computer Hardware & Consumables</button>
				                  <button class="flat-butt mobile1a" onclick="window.location.href = 'hardware';">COMP Hardware</button>
                              </div>
		              </div>
		          </div>
	            <!--  --div class="banner">
				<h2>Trouble-free Dispensing1</h2>
	       ...
	       <li>
	          <img src="images/headers/banner2.jpg" alt="">
	           <div class="div_btn">
		              <div class="col-md-12">
				               <div class="col-md-4">
				                   <button  class="flat-butt mobile1" onclick="window.location.href = 'our_software';">Pharmacy Management Systems</button>
	       ...
	       <li>
	          <img src="images/headers/banner3.jpg" alt="">
	           <div class="div_btn">
		              <div class="col-md-12">
				               <div class="col-md-4">
				                   <button  class="flat-butt mobile1" onclick="window.location.href = 'our_software';">Pharmacy Management Systems</button>
